...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      {/* Decorative background - matching reference image aesthetic */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-indigo-600/5 dark:from-indigo-500/5 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-violet-600/5 dark:from-violet-500/5 to-transparent rounded-full blur-3xl translate-y-1/2 -translate-x-1/3" />
      </div>
                            ...
                            >
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  setNewStatus(status as ProjectStatus);
                                  setContextMenuId(null);
                                }}
                                className="w-full flex items-center gap-2.5 px-3 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"
                              >
