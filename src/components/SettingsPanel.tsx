...
export const SettingsPanel: React.FC<{
  ...
  const handleTestNotification = async () => {
    ...
    try {
      ...
      if (resp.ok) {
        ...
        if (result.description?.includes("bot can't initiate conversation")) {
          setTimeout(
            () =>
              showToast(
                "Please send a message to your bot on Telegram first!",
                "error",
              ),
            2000,
          );
      ...
      showToast(
        "Error connecting to Telegram. Check your internet connection.",
        "error",
      );
    }
  };
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto w-full">
      <h2 className="text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 mb-6">
        Settings
      </h2>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm mb-6">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
          ...
          or talk to your own bot to get your Chat ID.
        </p>
